...
<div class="row mt">
	<div class="col-md-12">
		<div class="content-panel">
			<center><h2 style="font-style: sans-serif;"><b>Data transaksi</b></h2></center>
                  ...
                  <table class="table table-bordered" id="maintable" width="100%" cellspacing="0">
                    ...
                    $no = 0;
                      ...
                      $no++;
                        ...
                        <td>
                        <a href = 'home.php?page=update_transaksi&id_transaksi=$row[id_transaksi]'><button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a>
                        <a href= 'home.php?page=detail_transaksi&id_transaksi=$row[id_transaksi]' <button class='btn btn-primary btn-xs'><i class='fa fa-info'></i></button> </a>
                        <a href = 'aksi.php?act=hapus_transaksi&id_transaksi=$row[id_transaksi]' onClick=\"return confirm ('apakah anda benar akan menghapus post Nomor $row[id_transaksi]?')\"><button class='btn btn-danger btn-xs'><i class='fa fa-trash-o '></i></button></a>
                        </td>
                        </tr>
                        ";
                      }
